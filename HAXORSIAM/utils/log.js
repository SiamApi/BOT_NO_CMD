...
module.exports.loader = (data, option) => {
	switch (option) {
		case "warn":
			process.stderr.write(chalk.hex("#ff5208")(`\r» SIAM RAHMAN « `) + data + '\n');
			break;
		case "error":
			process.stderr.write(chalk.bold.hex("#ff0000").bold(`\r» SIAM RAHMAN « `) + data + '\n');
			break;
		default:
			process.stderr.write(chalk.cyan(`\r» SIAM RAHMAN « `) + data + '\n');
			break;
	}
}
